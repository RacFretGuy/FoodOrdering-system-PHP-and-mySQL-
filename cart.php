...
//   <?php
//   @header("Refresh:1; url=/public_html/cart.php");             
//   ?>
<script>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="index.php"> Cart
             (<?php
...
if(!empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div>
        <h1 class="titulo">Your Shopping Cart</h1>        
      </div>
...
<?php
  echo '<a href="cart.php?action=empty"><button class="btn btn-success"> Empty Cart</button></a>&nbsp;<a href="index.php"><button class="btn btn-success">Continue Shopping</button></a>&nbsp;<a href="payment.php"><button class="btn btn-success pull-right"> Check Out</button></a>';
?>
</div>
