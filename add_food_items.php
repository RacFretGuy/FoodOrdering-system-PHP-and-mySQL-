      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"> <a href="managerlogin.php">Manage Restaurant</a></li>
...
<div class="container">
    <div>
     <h1 class="titulo">Hello Restaurant! </h1>
     <p>Manage all your restaurant operations from here</p>
...
<div class="container">
    <div class="container">
        ...
        <a href="view_food_items.php" class="list-group-item">View Food Items</a>
    		<a href="add_food_items.php" class="list-group-item active">Add To Menu</a>
    ...
    <div class="col-xs-9">
      <div style="background-color:black;"  class="form-area" style="padding: 0px 100px 100px 100px;">
