    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO orders (F_ID, foodname, price,  quantity, order_date, username, R_ID) 
      ...
      if(!$success)
      {
        ...
        <div class="container">
          <div >
            <h1 class="titulo">Something went wrong!</h1>
            <p>Try again later.</p>
          </div>
        </div>
        ...
        <br>
<h1 class="text-center">Amount: Rs: <?php echo "$gtotal"; ?>/-</h1>
<h5 class="text-center">Proceed to pay</h5>
<br>
<h1 class="text-center">
  <a href="cart.php"><button class="btn btn-success">Go back to cart</button></a>
